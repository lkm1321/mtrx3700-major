...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Tute_3_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../main.c ../../../../../../../lib/salvo/src/init.c ../../../../../../../lib/salvo/src/inittask.c ../../../../../../../lib/salvo/src/mem.c ../../../../../../../lib/salvo/src/portpic18.c ../../../../../../../lib/salvo/src/qins.c ../../../../../../../lib/salvo/src/sched.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1971946829/init.o ${OBJECTDIR}/_ext/1971946829/inittask.o ${OBJECTDIR}/_ext/1971946829/mem.o ${OBJECTDIR}/_ext/1971946829/portpic18.o ${OBJECTDIR}/_ext/1971946829/qins.o ${OBJECTDIR}/_ext/1971946829/sched.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/main.o.d ${OBJECTDIR}/_ext/1971946829/init.o.d ${OBJECTDIR}/_ext/1971946829/inittask.o.d ${OBJECTDIR}/_ext/1971946829/mem.o.d ${OBJECTDIR}/_ext/1971946829/portpic18.o.d ${OBJECTDIR}/_ext/1971946829/qins.o.d ${OBJECTDIR}/_ext/1971946829/sched.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1971946829/init.o ${OBJECTDIR}/_ext/1971946829/inittask.o ${OBJECTDIR}/_ext/1971946829/mem.o ${OBJECTDIR}/_ext/1971946829/portpic18.o ${OBJECTDIR}/_ext/1971946829/qins.o ${OBJECTDIR}/_ext/1971946829/sched.o

# Source Files
SOURCEFILES=../main.c ../../../../../../../lib/salvo/src/init.c ../../../../../../../lib/salvo/src/inittask.c ../../../../../../../lib/salvo/src/mem.c ../../../../../../../lib/salvo/src/portpic18.c ../../../../../../../lib/salvo/src/qins.c ../../../../../../../lib/salvo/src/sched.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Tute_3_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Tute_3_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.Tute_3_Pro.X.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/Tute_3_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/Tute_3_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.Tute_3_Pro.X.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/Tute_3_Pro.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
