...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Tute_4_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../../../../../../../lib/salvo/src/binsem.c ../../../../../../../lib/salvo/src/event.c ../../../../../../../lib/salvo/src/init.c ../../../../../../../lib/salvo/src/inittask.c ../../../../../../../lib/salvo/src/mem.c ../../../../../../../lib/salvo/src/portpic18.c ../../../../../../../lib/salvo/src/qins.c ../../../../../../../lib/salvo/src/sched.c ../main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1971946829/binsem.o ${OBJECTDIR}/_ext/1971946829/event.o ${OBJECTDIR}/_ext/1971946829/init.o ${OBJECTDIR}/_ext/1971946829/inittask.o ${OBJECTDIR}/_ext/1971946829/mem.o ${OBJECTDIR}/_ext/1971946829/portpic18.o ${OBJECTDIR}/_ext/1971946829/qins.o ${OBJECTDIR}/_ext/1971946829/sched.o ${OBJECTDIR}/_ext/1472/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1971946829/binsem.o.d ${OBJECTDIR}/_ext/1971946829/event.o.d ${OBJECTDIR}/_ext/1971946829/init.o.d ${OBJECTDIR}/_ext/1971946829/inittask.o.d ${OBJECTDIR}/_ext/1971946829/mem.o.d ${OBJECTDIR}/_ext/1971946829/portpic18.o.d ${OBJECTDIR}/_ext/1971946829/qins.o.d ${OBJECTDIR}/_ext/1971946829/sched.o.d ${OBJECTDIR}/_ext/1472/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1971946829/binsem.o ${OBJECTDIR}/_ext/1971946829/event.o ${OBJECTDIR}/_ext/1971946829/init.o ${OBJECTDIR}/_ext/1971946829/inittask.o ${OBJECTDIR}/_ext/1971946829/mem.o ${OBJECTDIR}/_ext/1971946829/portpic18.o ${OBJECTDIR}/_ext/1971946829/qins.o ${OBJECTDIR}/_ext/1971946829/sched.o ${OBJECTDIR}/_ext/1472/main.o

# Source Files
SOURCEFILES=../../../../../../../lib/salvo/src/binsem.c ../../../../../../../lib/salvo/src/event.c ../../../../../../../lib/salvo/src/init.c ../../../../../../../lib/salvo/src/inittask.c ../../../../../../../lib/salvo/src/mem.c ../../../../../../../lib/salvo/src/portpic18.c ../../../../../../../lib/salvo/src/qins.c ../../../../../../../lib/salvo/src/sched.c ../main.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Tute_4_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1971946829/binsem.o: ../../../../../../../lib/salvo/src/binsem.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1971946829 
	@${RM} ${OBJECTDIR}/_ext/1971946829/binsem.o.d 
	@${RM} ${OBJECTDIR}/_ext/1971946829/binsem.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -DSYSE -DMAKE_WITH_SOURCE -I"../" -I"../../../../../../../lib/salvo/inc" -ms -oa- -o- -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1971946829/binsem.o   ../../../../../../../lib/salvo/src/binsem.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1971946829/binsem.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1971946829/binsem.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1971946829/binsem.o: ../../../../../../../lib/salvo/src/binsem.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1971946829/binsem.o.d 
	@${RM} ${OBJECTDIR}/_ext/1971946829/binsem.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DSYSE -DMAKE_WITH_SOURCE -I"../" -I"../../../../../../../lib/salvo/inc" -ms -oa- -o- -Ou- -Ot- -Ob- -Op- -Or- -Od- -Opa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1971946829/binsem.o   ../../../../../../../lib/salvo/src/binsem.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1971946829/binsem.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1971946829/binsem.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Tute_4_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.Tute_4_Pro.X.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/Tute_4_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/Tute_4_Pro.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.Tute_4_Pro.X.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/Tute_4_Pro.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
